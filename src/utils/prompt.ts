...
const defaultPrompt = (promptOptions: PromptOptions) => {
    ...
    return [
        ...
        [
            ...
            '',
            `## Rules:`,
            `- Subject line: Max ${maxLength} characters, imperative mood, no period. Use original case for identifiers or abbreviations.`,
...
//        `   - Keep the title under ${maxLength} characters`,
//        '   - Do not end the title line with a period',
//        '   - Be specific but Concise.  Avoid redundancy.',
//        '   - Use the imperative mood (e.g., "Fix" instead of "Fixed" or "Fixes")',
//        '   - Wrap body lines at 78 characters',
//        '   - Avoid detailed explanations unless necessary for understanding the change.',
//        '   - Do not add unneccessary context or background information.',
//        '   - Do not add implementation details.',
//        //'   - Focus on the action and its direct outcome, not the consequence  (e.g., "Updated buzzer durations to meet 200 ms requirement" instead of "Updated buzzer durations to meet 200 ms requirement. This ensures correct operation.")',
//        '   - Use bullet points and Markdown headers as needed',
//        '5. *Focus* on:',
//        //'   - Include only essential information. Focus on the "what" and "why" rather than the "how".',
//        '   - The impact of the change, not the implementation details.',
//        '   - Problem solved by the commit',
//        '   - Functional necessity of the change',
//        '   - Important technical details',
//        '6. *Do*:',
//        '   - Not mention any readability, maintainability, confusion, copyright, translation reasons nor implementation details',
//        '   - NOT Explain consequences that are already implied (such as "to ensure the proper operation")',
        ].join('\n'),
    ]
        .filter(Boolean)
        .join('\n');
